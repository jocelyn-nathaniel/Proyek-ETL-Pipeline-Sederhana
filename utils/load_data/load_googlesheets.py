...
# pip install gspread gspread_dataframe google-auth google-api-python-client oauth2client
...
def saved_to_google_sheets(df: pd.DataFrame):
  if df is None or df.empty:
    logger.warning("DataFrame kosong sehingga tidak dikirim ke Google Sheets")
    return None 
